...
{
    /// <summary>
    /// The exception that is thrown when an operation fails as the target stream already exists.
    /// This class cannot be inherited.
    /// </summary>
    public sealed class EventStreamAlreadyExistsException : EventStreamException
    {
        /// <summary>
        ...
        private EventStreamAlreadyExistsException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
